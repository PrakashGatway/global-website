...
export default function HotelDetailsPage() {
  ...
  const fetchHotelDetails = async () => {
    try {
      ...
      const response = await axiosInstance.get(`/accommodation/hotels/${id}`);
      ...
      <div className="relative bg-gradient-to-r from-gray-900 to-gray-700 text-white">
        ...
        {allImages.length > 1 && (
          <>
            <button
              onClick={prevImage}
              className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 z-10 bg-black/30 hover:bg-black/50 text-white p-2 sm:p-3 rounded-full backdrop-blur-sm transition-all hover:scale-110 touch-manipulation"
            >
              <FaChevronLeft className="text-xl" />
            </button>
            <button
              onClick={nextImage}
              className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 z-10 bg-black/30 hover:bg-black/50 text-white p-2 sm:p-3 rounded-full backdrop-blur-sm transition-all hover:scale-110 touch-manipulation"
            >
        ...
        {/* Content */}
        <div className="relative z-8 container mx-auto px-4 sm:px-8 lg:px-16 py-16 sm:py-24 md:py-32">
          <div className="max-w-4xl">
            ...
            {/* Title */}
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 leading-tight break-words">
              {hotel.name}
            </h1>

            {/* Location */}
            <div className="flex items-start gap-2 text-gray-300 mb-4 text-sm sm:text-base">
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-2 sm:gap-3">
              <button className="w-full sm:w-auto justify-center bg-orange-500 hover:bg-orange-600 text-white px-6 sm:px-8 py-3 rounded-lg font-semibold transition-all sm:hover:scale-105 flex items-center gap-2">
                <FaCheckCircle /> Book Now
              </button>
              <button className="w-full sm:w-auto justify-center bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white px-6 py-3 rounded-lg font-semibold transition-all flex items-center gap-2">
            ...
            {/* Quick Info */}
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:flex lg:flex-wrap items-start gap-3 sm:gap-4 lg:gap-6 text-sm text-gray-300">
              <div className="flex items-center gap-2">
      ...
      <div className="container mx-auto px-3 sm:px-6 lg:px-8 py-5 sm:py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 sm:gap-8">
          ...
          <div className="lg:col-span-2 space-y-5 sm:space-y-8 min-w-0">
            {/* Quick Info Bar */}
            <div className="bg-white shadow-sm p-3 sm:p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 rounded-lg">
              ...
              <div className="flex items-start sm:items-center gap-2 sm:gap-4 text-sm w-full sm:w-auto">
            ...
            <div className="bg-white p-4 sm:p-6 lg:p-8 shadow-sm rounded-lg">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                <span className="w-1 h-6 sm:h-8 bg-orange-500 flex-shrink-0"></span>
                About the Property
              </h2>
            ...
            <div className="bg-white p-4 sm:p-6 shadow-sm rounded-lg">
              ...
              {/* Map Container */}
              <div className={`overflow-hidden transition-all duration-500 ${showMap ? 'h-[18rem] sm:h-[24rem]' : 'h-[16rem] sm:h-[20rem]'}`}>
              ...
              <div className="space-y-4">
                {hotel.roomTypes.map((room, index) => (
                  ...
                  >
                    <div className="flex flex-col lg:flex-row justify-between items-stretch lg:items-start gap-4">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start sm:items-center gap-3 sm:gap-4 min-w-0">
                          ...
                          <div>
                            <h3 className="text-lg sm:text-xl font-bold text-gray-900 break-words">{room.name}</h3>
                        ...
                        <p className="text-sm text-gray-600 mt-3 sm:ml-16 leading-relaxed">{room.description}</p>
                      </div>
                      
                      <div className="text-left sm:text-right w-full lg:w-auto lg:min-w-[140px]">
                        <div className="text-2xl font-bold text-orange-600">
                          {hotel.currency}{room.price}
                        </div>
                        <div className="text-[10px] sm:text-xs text-gray-500 uppercase tracking-wider text-center truncate max-w-full">Per Night</div>
                        <button 
                          className={`mt-3 px-6 sm:px-8 py-2.5 text-sm font-medium transition-colors w-full rounded-lg ${
                            selectedRoom === index 
                    ...
                    {/* Room Inclusions */}
                    <div className="mt-4 pt-4 border-t border-gray-200 flex flex-wrap gap-2 sm:gap-3">
                    ...
                    {displayedReviews.map((review, index) => (
                      <div key={index} className="border-b border-gray-200 last:border-0 pb-6 last:pb-0">
                        <div className="flex items-start gap-3 sm:gap-4">
                          <div className="w-10 h-10 sm:w-12 sm:h-12 bg-orange-500 flex items-center justify-center text-white font-bold text-base sm:text-lg flex-shrink-0 rounded-full">
                            {review.user.charAt(0).toUpperCase()}
                          </div>
                          <div className="flex-1 min-w-0">
                            <div className="flex flex-col xs:flex-row sm:flex-row items-start sm:items-center justify-between gap-2 mb-2">
                              <div>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="bg-white p-4 sm:p-6 shadow-sm rounded-lg">
              <div className="text-center">
                ...
                <button className="w-full mt-4 bg-orange-500 text-white py-3.5 sm:py-4 font-bold text-base sm:text-lg hover:bg-orange-600 transition-colors rounded-lg">
                  Book Now
                </button>
            ...
            <div className="bg-white p-4 sm:p-6 shadow-sm rounded-lg">
              ...
              <div className="space-y-3">
                {hotel.contactInfo.phone && (
                  <div className="flex items-center gap-2 sm:gap-3 p-3 bg-gray-50 hover:bg-orange-50 transition-colors rounded-lg group min-w-0">
                    ...
                    <a href={`tel:${hotel.contactInfo.phone}`} className="text-sm text-gray-700 hover:text-orange-600 break-all min-w-0">
                      {hotel.contactInfo.phone}
                    </a>
                  </div>
                )}
                {hotel.contactInfo.email && (
                  <div className="flex items-center gap-2 sm:gap-3 p-3 bg-gray-50 hover:bg-orange-50 transition-colors rounded-lg group min-w-0">
                    ...
                    <a href={`mailto:${hotel.contactInfo.email}`} className="text-sm text-gray-700 hover:text-orange-600 truncate min-w-0">
                      {hotel.contactInfo.email}
                    </a>
                  </div>
                )}
                {hotel.contactInfo.website && (
                  <div className="flex items-center gap-2 sm:gap-3 p-3 bg-gray-50 hover:bg-orange-50 transition-colors rounded-lg group min-w-0">
                    ...
                    <a href={hotel.contactInfo.website} target="_blank" rel="noopener noreferrer" className="text-sm text-gray-700 hover:text-orange-600 break-all min-w-0">
                      Visit Website
                    </a>
                  </div>
                )}
            ...
            <div className="bg-white p-4 sm:p-6 lg:p-8 shadow-sm rounded-lg">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 sm:gap-4">
                {propertyFeatures.map((feature, index) => (
                  <div key={index} className="flex items-center flex-col py-3 px-2 gap-2 sm:gap-3 bg-gray-50 hover:bg-orange-50 transition-colors rounded-lg group min-w-0">
                    
                      <div className="text-[10px] sm:text-xs text-gray-500 uppercase tracking-wider text-center truncate max-w-full">{feature.label}</div>
                    <div className='flex gap-2 sm:gap-4 items-center justify-center'>
                      <div className="w-9 h-9 sm:w-10 sm:h-10 bg-orange-100 group-hover:bg-orange-200 transition-colors flex items-center justify-center rounded-lg flex-shrink-0">
                      <feature.icon className="text-orange-500 text-lg" />
                    </div>
                      <div className="font-bold text-gray-900 text-base sm:text-lg">{feature.value}</div>
                    </div>
                  </div>
                ))}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                {hotel.amenities.map((amenity, index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="flex items-center gap-2 sm:gap-3 p-3 bg-gray-50 hover:bg-orange-50 transition-colors rounded-lg group min-w-0"
                    >
                      <div className="w-8 h-8 bg-orange-100 group-hover:bg-orange-200 transition-colors flex items-center justify-center rounded-lg">
                        <Icon className="text-orange-600 text-sm" />
                      </div>
                      <span className="text-sm font-medium text-gray-700 group-hover:text-orange-600 transition-colors break-words min-w-0">
                        {amenity}
                      </span>
                    </div>
                  );

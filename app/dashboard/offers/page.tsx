...
export default function OffersPage() {
  ...
  return (
    <main className="flex-1 overflow-y-auto min-h-[70vh]">
      <div className="container mx-auto py-3 sm:px-4 space-y-6">
        ...
        <div className="flex gap-1 sm:gap-2 border-b border-slate-200 bg-white sticky top-0 z-10 -mx-4 sm:mx-0 px-4 sm:px-0 pt-2 sm:pt-0 overflow-x-auto scrollbar-hide">
          {['refer', 'coupons', "rewards"].map((tab) => (
            <motion.button
              ...
              className={`pb-2.5 sm:pb-3 px-2.5 sm:px-3 font-semibold text-xs sm:text-sm whitespace-nowrap flex items-center gap-1.5 sm:gap-2 transition-all relative ${activeTab === tab ? 'text-slate-900' : 'text-slate-500 hover:text-slate-700'
                }`}
            >

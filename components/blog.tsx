...
export default function Blogs({ Blogdata, categoryData, page, limit, total }) {
        ...
        <div className="container mx-auto px-3 sm:px-6">
          <div className="max-w-4xl mx-auto text-left lg:text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 mb-6 sm:mb-8 justify-start lg:justify-center">
              ...
              <button className="w-full sm:w-[200px] px-4 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base bg-white text-[#FF6B35] rounded-none font-bold hover:bg-gray-100 transition-all whitespace-nowrap">
                I AM IN
              </button>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed mb-8">
                Have question about studying abroad ? Fill out the form below
                and our education experts will get back to you within 24 hours
              </p>
                ...
                {[
                  {
                    title: "Why Choose Us?",
                    subtitle:
                      "Get personalized guidance from experienced counselors who understand your academic goals and career aspirations.",
                  },
                  {
                    title: "Quick Response",
                    subtitle:
                      "Our team ensures a quick response within 24 hours. For urgent queries, feel free to call us directly.",
                  },
                ].map((point, index) => (
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  >
                    I agree to receive updates and promotional materials from
                    Ooshas Global
                  </label>
                  {errors.terms && (
                    <p className="text-red-500 text-sm mt-1">

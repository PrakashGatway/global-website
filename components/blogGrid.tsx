...
export default function BlogGrid({ filteredBlogs }) {
  ...
  return (
    <>
      <section className=" py-12 sm:py-14 lg:py-4 px-4 relative overflow-hidden bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-10 relative z-[10]">
                ...
                >
                  ...
                  <div className="p-4 pt-2 text-start">
                    <h3
                      ...
                      className="text-gray-900 hover:text-[#FF6B35] cursor-pointer text-lg font-medium mb-1 line-clamp-2"
                    >
                      {post.title}
                    </h3>
                    <div
                      className="
    !text-gray-600 !text-sm !font-medium !mb-2 !line-clamp-2
    [&_*]:!text-gray-700
    [&_*]:!text-sm
    [&_*]:!font-medium
    [&_*]:!mt-0

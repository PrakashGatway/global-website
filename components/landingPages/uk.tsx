...
const testimonials = [
    {
        ...
        review:
            "Ooshas Global provided excellent guidance throughout my UK admission process. Their counselors helped me shortlist public universities and prepare strong applications.",
...

    {
        ...
        review:
            "I was confused about APS, blocked account, and visa procedures, but Ooshas Global guided me perfectly and made the UK process smooth.",
        score: "Visa Approved",
        country: "UK",
    },

    {
        ...
        review:
            "The entire UK admission journey became stress-free because of Ooshas Global. Their SOP guidance and documentation support were outstanding.",
...

    {
        ...
        review:
            "I had an amazing experience with Ooshas Global. Their transparent process and UK counseling made my dream of studying abroad possible.",
        score: "Student Visa",
        country: "UK",
    },
...

    {
        ...
        review:
            "Ooshas Global made the whole UK process stress-free. Their visa interview preparation and blocked account guidance were incredibly helpful.",
        score: "Visa Success",
        country: "UK",
    },

    {
        ...
        review:
            "From documentation to university applications, every step was handled professionally. I highly recommend Ooshas Global for UK study guidance.",
...

    {
        ...
        review:
            "The counselors genuinely cared about my future and guided me at every stage of my UK study abroad journey. Their support gave me confidence.",
...
export default function UkLanding() {
    ...
    const faqs = [
        {
            q: "Are Bachelor's programs available in English in UK?",
        ...
        {
            q: "Are scholarships available for Indian students in UK?",
        ...
        {
            q: "Can I study in UK without IELTS?",
        ...
        {
            q: "What is APS certification for UK?",
        ...
        {
            q: "Can international students work while studying in UK?",
        ...
        {
            q: "Is UK a good option for MBA studies?",
            a: "Absolutely. UK offers globally recognized MBA and management programs with strong industry exposure and excellent career opportunities.",
        },
        {
            q: "Can students stay in UK after graduation?",
            a: "Yes, graduates can apply for a post-study work permit and stay in UK to search for full-time job opportunities after completing their studies.",
        },
    ];
    ...
    const universities = [
        {
            ...
            address: "Arcisstraße 21, 80333 Munich, Bavaria, UK",
            description:
                "The Technical University of Munich is a public research university in Munich, Bavaria, UK. It specializes in engineering, technology, medicine, and applied and natural sciences.",
        },
        {
            id: 2,
            ...
            address: "Kaiserswerther Str. 16–18, 14195 Berlin, UK",
            description:
        ...
        },
        {
            ...
            address: "Geschwister-Scholl-Platz 1, 80539 Munich, UK",
            description:
                "The Ludwig Maximilian University of Munich is a public research university in Munich, Bavaria, UK, and one of UK's oldest universities.",
        },
        {
            id: 4,
            ...
            address: "Mittelweg 177, 20148 Hamburg, UK",
            description:
                "The University of Hamburg is a public research university founded in 1919 and is one of UK’s largest universities.",
        },
        {
            id: 5,
            ...
            address: "Unter den Linden 6, 10099 Berlin, UK",
            description:
        ...
        },
        {
            ...
            address: "Kaiserstraße 12, 76131 Karlsruhe, UK",
            description:
        ...
        <div className={`min-h-screen bg-white text-[#0b2545]`}>
            ...
            <section id="home" className="relative overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        backgroundImage: `url('https://yesUK.com/wp-content/uploads/2024/10/WhatsApp-Image-2024-10-15-at-14.41.53.jpeg')`,
                    }}
                >
                ...
                <div className="relative max-w-7xl mx-auto px-4 py-12 lg:py-12 grid grid-cols-1 lg:grid-cols-3 gap-3 items-center">
                    ...
                    <div className="lg:col-span-2 text-black">
                        ...
                        <h1 className="mt-5 text-3xl sm:text-5xl font-bold leading-tight">
                            <span className="text-black">Make Your Study In <span className="text-[#F46C44]">UK</span> <br /> Dream Into A Reality</span>
                        </h1>

                        <ul className="mt-3 grid grid-cols-1 sm:grid-cols-1 gap-1.5 text-black font-medium">
                            {[
                                "Assured Admission in UK's Top Universities",
                ...
                <div className="relative max-w-7xl mx-auto px-4">
                    <div className="text-center max-w-5xl mx-auto mb-14">
                        ...
                        <p className="mt-3 text-base text-[#0b2545]/80 font-medium leading-8">
                            Here are some of the top universities in UK for students to study in UK.
                        </p>
                    </div>
            ...
            <section className="relative py-12 bg-gradient-to-b from-white to-[#fff7f3] overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4">
                    <div className="text-center max-w-4xl mx-auto mb-8">
                        ...
                        <p className="mt-3 text-base text-[#0b2545]/80 font-medium leading-8">
                            Explore the most in-demand courses in UK that offer strong
                    ...
                    <div className="grid lg:grid-cols-2 gap-14 items-center">
                        <div>
                            <h2 className="text-3xl sm:text-4xl font-semibold leading-tight text-black max-w-2xl">
                                Most Trusted <span className="text-[#F46C44]">UK Education Consultant</span>
                            </h2>

                            {/* Description */}
                            <div className="mt-3 space-y-3">
                                <p className="text-base sm:text-lg text-[#222]">
                                    Are you looking to undertake your higher studies in UK?

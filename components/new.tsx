...
export default function UniDetailsClient({
  data,
  Faqres,
  Universityres,
}: {
    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-10">
        <h2 className="font-bold text-3xl">
          Explore More Universities for Your Study Plans
        </h2>

        <UniversityCard
          university={Universityres.map((uni) =>
            uni._id === data._id ? null : uni,
          ).filter(Boolean)}
        />
      </div>
      ...
      <section className="relative bg-[#ee6a43] overflow-hidden py-12 sm:py-16 lg:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-0">
          ...
          <div className="text-white relative z-10">
            ...
            <p className="mt-4 text-sm sm:text-base lg:text-lg max-w-xl text-white/90">
              {data?.extra_content?.extra?.ctadescription}
            </p>
